...
function validateArray(value: readonly unknown[], ancestors: WeakSet<object>): void {
  if (Object.getPrototypeOf(value) !== Array.prototype) {
    throw serializationError("an array with a nonstandard prototype");
  }
...
function validateObject(value: object, ancestors: WeakSet<object>): void {
  const prototype: unknown = Object.getPrototypeOf(value);
  if (prototype !== Object.prototype && prototype !== null) {
    throw serializationError("a non-plain object");
  }
...
function validateValue(value: unknown, ancestors: WeakSet<object>): void {
  if (value === null || typeof value === "boolean" || typeof value === "string") {
    return;
  }
  if (typeof value === "number") {
    if (!Number.isFinite(value)) throw serializationError("a non-finite number");
    return;
  }
  if (typeof value !== "object") {
    throw serializationError(`a value of type ${typeof value}`);
...
export function assertCanonicalSerializable(value: unknown): void {
  validateValue(value, new WeakSet<object>());
}
