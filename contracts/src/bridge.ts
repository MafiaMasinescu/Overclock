import type { SimCommand, CommandResult } from "./commands";
import type { SimEvent } from "./events";
import type { GridPoint, ModuleDefinitionId, ModuleInstanceId, Rotation } from "./types";
import type { GridViewModel, UiSnapshot } from "./snapshots";
...
export type GridIntent =
  ...
  | { kind: "REQUEST_PLACE_MODULE"; definitionId: ModuleDefinitionId; position: GridPoint; rotation: Rotation }
